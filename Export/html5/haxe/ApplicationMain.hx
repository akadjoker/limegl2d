...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		lime.system.System.__registerEntryPoint ("BunnyMark", create);
	...
	public static function create (config:Dynamic):Void {
		...
		#if !munit
		var app = new Main ();
		app.meta.set ("build", "237");
		app.meta.set ("company", "OpenFL");
		app.meta.set ("file", "BunnyMark");
		app.meta.set ("name", "BunnyMark");
		app.meta.set ("packageName", "org.openfl.lime.demos.bunnymark");
